module {
  aie.device(npu1_4col) {
    ...
    aie.flow(%mem_tile_0_1, DMA : 3, %tile_2_2, DMA : 0)
    aie.flow(%mem_tile_0_1, DMA : 3, %tile_3_2, DMA : 0)
    aie.flow(%shim_noc_tile_0_0, DMA : 0, %mem_tile_0_1, DMA : 0)
    aie.flow(%mem_tile_1_1, DMA : 0, %tile_2_3, DMA : 1)
    ...
    aie.flow(%mem_tile_1_1, DMA : 2, %tile_0_2, DMA : 1)
    aie.flow(%mem_tile_1_1, DMA : 2, %tile_2_2, DMA : 1)
    aie.flow(%mem_tile_1_1, DMA : 3, %tile_3_2, DMA : 1)
    ...
    aie.flow(%tile_1_2, DMA : 0, %mem_tile_2_1, DMA : 1)
    aie.flow(%tile_2_2, DMA : 0, %mem_tile_2_1, DMA : 2)
    aie.flow(%tile_3_2, DMA : 0, %mem_tile_2_1, DMA : 3)
