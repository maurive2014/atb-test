...
4:                                                ; preds = %1
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr getelementptr inbounds nuw (i8, ptr @_anonymous0, i64 4096), ptr @pipe_c_0_dst_cons_buff_1, i64 4096, i1 false)
  call void @llvm.aie2.release(i32 48, i32 1)
  call void @llvm.aie2.acquire(i32 50, i32 -1)
  call void @llvm.assume(i1 true) [ "align"(ptr @_anonymous0, i64 32) ]
  ...
  call void @llvm.assume(i1 true) [ "align"(ptr @_anonymous0, i64 32) ]
  call void @llvm.assume(i1 true) [ "align"(ptr @fifo_4_buff_0, i64 32) ]
  call void @llvm.memcpy.p0.p0.i64(ptr @fifo_4_buff_0, ptr getelementptr inbounds nuw (i8, ptr @_anonymous0, i64 4096), i64 4096, i1 false)
  call void @llvm.aie2.release(i32 51, i32 1)
  call void @llvm.aie2.acquire(i32 49, i32 -1)
  call void @llvm.assume(i1 true) [ "align"(ptr @_anonymous0, i64 32) ]
  call void @llvm.assume(i1 true) [ "align"(ptr @pipe_c_0_dst_cons_buff_0, i64 32) ]
  ...
  call void @llvm.assume(i1 true) [ "align"(ptr @_anonymous0, i64 32) ]
  call void @llvm.assume(i1 true) [ "align"(ptr @fifo_4_buff_1, i64 32) ]
  call void @llvm.memcpy.p0.p0.i64(ptr @fifo_4_buff_1, ptr getelementptr inbounds nuw (i8, ptr @_anonymous0, i64 4096), i64 4096, i1 false)
  call void @llvm.aie2.release(i32 51, i32 1)
  %5 = add i64 %2, 2
  br label %1
