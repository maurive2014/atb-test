module {
  ...
  func.func @compute_c_0(%arg0: memref<16x64xi16>, %arg1: memref<64x64xi16>, %arg2: !allo.stream<memref<16x64xi16>, 2>) attributes {df.kernel, itypes = "ss_", otypes = "", stypes = "__o", tag = "compute_c_()"} {
    ...
    call @fill_zeros_i16_16_64_vector(%alloc) {lib = "fill_zeros_i16_16_64_vector"} : (memref<16x64xi16>) -> ()
    call @matmul_scalar_i16_i16(%arg0, %arg1, %alloc) {lib = "matmul_scalar_i16_i16"} : (memref<16x64xi16>, memref<64x64xi16>, memref<16x64xi16>) -> ()
  ...
  func.func @compute_c_1(%arg0: memref<16x64xi16>, %arg1: memref<64x64xi16>, %arg2: !allo.stream<memref<16x64xi16>, 2>) attributes {df.kernel, input_depth = [0, 0, 0], output_depth = []} {
    %c0_i16 = arith.constant 0 : i16
    %alloc = memref.alloc() : memref<16x64xi16>
    call @fill_zeros_i16_16_64_vector(%alloc) {lib = "fill_zeros_i16_16_64_vector"} : (memref<16x64xi16>) -> ()
    call @matmul_scalar_i16_i16(%arg0, %arg1, %alloc) {lib = "matmul_scalar_i16_i16"} : (memref<16x64xi16>, memref<64x64xi16>, memref<16x64xi16>) -> ()
  ...
  func.func @compute_c_2(%arg0: memref<16x64xi16>, %arg1: memref<64x64xi16>, %arg2: !allo.stream<memref<16x64xi16>, 2>) attributes {df.kernel, input_depth = [0, 0, 0], output_depth = []} {
    %c0_i16 = arith.constant 0 : i16
    %alloc = memref.alloc() : memref<16x64xi16>
    call @fill_zeros_i16_16_64_vector(%alloc) {lib = "fill_zeros_i16_16_64_vector"} : (memref<16x64xi16>) -> ()
    call @matmul_scalar_i16_i16(%arg0, %arg1, %alloc) {lib = "matmul_scalar_i16_i16"} : (memref<16x64xi16>, memref<64x64xi16>, memref<16x64xi16>) -> ()
  ...
  func.func @compute_c_3(%arg0: memref<16x64xi16>, %arg1: memref<64x64xi16>, %arg2: !allo.stream<memref<16x64xi16>, 2>) attributes {df.kernel, input_depth = [0, 0, 0], output_depth = []} {
    %c0_i16 = arith.constant 0 : i16
    %alloc = memref.alloc() : memref<16x64xi16>
    call @fill_zeros_i16_16_64_vector(%alloc) {lib = "fill_zeros_i16_16_64_vector"} : (memref<16x64xi16>) -> ()
    call @matmul_scalar_i16_i16(%arg0, %arg1, %alloc) {lib = "matmul_scalar_i16_i16"} : (memref<16x64xi16>, memref<64x64xi16>, memref<16x64xi16>) -> ()
